...
def saAmfDispatch(amfHandle, dispatchFlags):
    ...
    return type:
        SaAisErrorT
    """
    return clLib.libmw_so.saAmfDispatch(
        amfHandle,
        dispatchFlags
    )
...
def saAmfFinalize(amfHandle):
    ...
    return type:
        SaAisErrorT
    """
    return clLib.libmw_so.saAmfFinalize(
        amfHandle
    )
...
def saAmfCSIQuiescingComplete(amfHandle, invocation, error):
    ...
    return type:
        SaAisErrorT
    """
    return clLib.libmw_so.saAmfCSIQuiescingComplete(
        amfHandle,
        invocation,
        error
    )
...
def saAmfResponse(amfHandle, invocation, error):
    ...
    return type:
        SaAisErrorT
    """
    return clLib.libmw_so.saAmfResponse(
        amfHandle,
        invocation,
        error
    )
