...
class eClAmsMgmtClientCallbackRmdInterfaceT(clUtils.CEnum):
...
class eClAmsTLVTypeT(clUtils.CEnum):
    CL_AMS_TLV_TYPE_ENTITY       = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_ENTITY.value,
    CL_AMS_TLV_TYPE_NODE         = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_NODE.value,
    CL_AMS_TLV_TYPE_APP          = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_APP.value,
    CL_AMS_TLV_TYPE_SG           = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_SG.value,
    CL_AMS_TLV_TYPE_SU           = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_SU.value,
    CL_AMS_TLV_TYPE_SI           = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_SI.value,
    CL_AMS_TLV_TYPE_COMP         = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_COMP.value,
    CL_AMS_TLV_TYPE_CSI          = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_CSI.value,
    CL_AMS_TLV_TYPE_CLUSTER      = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_CLUSTER.value,
    CL_AMS_TLV_TYPE_START_LIST   = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_CLUSTER.value + 1,
    CL_AMS_TLV_TYPE_END_LIST     = clAmsEntities.eClAmsEntityTypeT.CL_AMS_ENTITY_TYPE_CLUSTER.value + 2,

ClAmsMgmtCCBOperationsT = clCommon.ClInt32T
class eClAmsMgmtCCBOperationsT(clUtils.CEnum):
    CL_AMS_MGMT_CCB_OPERATION_CREATE = 1
    CL_AMS_MGMT_CCB_OPERATION_DELETE = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_CONFIG = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_CSI_SET_NVP = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_NODE_DEPENDENCY = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_NODE_SU_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_SG_SU_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_SG_SI_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_SU_COMP_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_SI_SU_RANK_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_SI_SI_DEPENDENCY_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_SI_CSI_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_SET_CSI_CSI_DEPENDENCY_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_CSI_DELETE_NVP = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_DELETE_NODE_DEPENDENCY = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_DELETE_NODE_SU_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_DELETE_SG_SU_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_DELETE_SG_SI_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_DELETE_SU_COMP_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_DELETE_SI_SU_RANK_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_DELETE_SI_SI_DEPENDENCY_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_DELETE_CSI_CSI_DEPENDENCY_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_DELETE_SI_CSI_LIST = enum.auto()
    CL_AMS_MGMT_CCB_OPERATION_MAX = enum.auto()
...
class eClAmsMgmtSubAreaT(clUtils.CEnum):
