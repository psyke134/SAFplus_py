...
class eClAmsPresenceStateT(clUtils.Enum):
...
class eClAmsReadinessStateT(clUtils.Enum):
...
class eClAmsServiceStateT(clUtils.Enum):
...
class eClAmsNodeClassT(clUtils.Enum):
...
class eClAmsNodeClusterMemberT(clUtils.Enum):
...
class eClAmsSGRedundancyModelT(clUtils.Enum):
...
class eClAmsSGLoadingStrategyT(clUtils.Enum):
...
class eClAmsCompCapModelT(clUtils.Enum):
...
class eClAmsCompPropertyT(clUtils.Enum):
...
class eClAmsCompHealthcheckInvocationT(clUtils.Enum):
...
class eClAmsRecoveryT(clUtils.Enum):
...
class eClAmsCSITransitionDescriptorT(clUtils.Enum):
